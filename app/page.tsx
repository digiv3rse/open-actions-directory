      ...
      >
        ...
        >
          ...
          '>
            ...
            />
            <p className='ml-2 font-medium text-[#343433]'>DiGi</p>
          ...
          <p
             ...
             '
          >
            Open Actions bring the power of smart contracts into the feed. Engage a wider audience with interactive web3 experiences seamlessly integrated across the DiGi ecosystem.
          </p>
          <p
            className='
            hidden pr-10 mt-5
          ...
          <div className='mt-7 flex'>
            ...
            <Link
              href="https://github.com/digiv3rse/verified-modules"
              target="_blank"
              rel="noopener noreferrer"
              className='
              flex items-center
