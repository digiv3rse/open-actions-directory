      ...
      <div className="border-b">
        <div className="px-4 md:px-8 py-3 flex flex-1">
          ...
          <div className="hidden lg:flex flex-row items-center">
            ...
            <a
              href="https://docs.digiv3rse.xyz/v2/docs/creating-a-publication-action"
              target="_blank"
              rel="noopener"
            >
            ...
            <a
              href="https://github.com/digiv3rse/open-actions-directory/blob/main/open_actions_pr_template.md"
              target="_blank"
              rel="noopener"
            >
            ...
            <a
              href="https://docs.digiv3rse.xyz/v2/docs/what-is-digiv3rse"
              target="_blank"
              rel="noopener"
            >
              <p className="hover:text-foreground transition duration-300 text-muted-foreground text-sm ml-5">
